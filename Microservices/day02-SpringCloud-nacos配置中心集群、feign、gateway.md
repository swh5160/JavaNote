...
![image-20230505145721242](assets/image-20230505145721242.png)
...
![image-20230505214551883](assets/image-20230505214551883.png)

![image-20230505214611492](assets/image-20230505214611492.png)
...
![image-20230505220841687](assets/image-20230505220841687.png)

问号后面第一个参数正确返回结果

![image-20230505220942725](assets/image-20230505220942725.png)
...
浏览器每次访问服务端会发起一个OPTIONS是否允许跨域请求，add-to-simple-url-handler-mapping: true 用来允许接收这个请求，maxAge在这段时间内有效就像cookice，不需要频繁访问
...
public class BaseConfig {
    ...
    CorsFilter getCorsFilter(){
        ...
        //允许请求地址
        configuration.addAllowedOrigin("http://192.168.80.121");
        //允许请求方式
